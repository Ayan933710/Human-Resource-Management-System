// [SHARED] Thin bootstrap. AUTH-BACKEND owns the real version.
...
app.use(session({ secret: process.env.SESSION_SECRET || 'dev_secret',
...
app.get('/', (req, res) => res.redirect(req.session.user ? '/profile' : '/login'));
